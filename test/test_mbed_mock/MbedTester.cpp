...
MbedTester::MbedTester(DigitalIn &testDigitalIn, DigitalOut &testDigitalOut,
                       CAN &testCAN)
    : privateTestDigitalIn(testDigitalIn),
      privateTestDigitalOut(testDigitalOut), privateTestCAN(testCAN) {}
...
int MbedTester::testDigitalInRead() { return privateTestDigitalIn.read(); }

/****************************** DigitalOut tests ******************************/

void MbedTester::testDigitalOutWrite(DigitalOut &testDigitalOut,
                                     int testValue) {
