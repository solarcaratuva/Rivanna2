...
#define MotorControllerPowerStatus_MESSAGE_ID MOTOR_CONTROLLER_MOTOR_CONTROLLER_POWER_STATUS_FRAME_ID
#define MotorControllerDriveStatus_MESSAGE_ID MOTOR_CONTROLLER_MOTOR_CONTROLLER_DRIVE_STATUS_FRAME_ID
#define MotorControllerError_MESSAGE_ID MOTOR_CONTROLLER_MOTOR_CONTROLLER_ERROR_FRAME_ID
